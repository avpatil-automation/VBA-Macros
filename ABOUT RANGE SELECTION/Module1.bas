...
Sub RangeDescription()
    ...
    FirstAreaType = AreaType(Selection)
...
Private Function AreaType(RangeArea As Range) As String
    ...
    Select Case True
        Case RangeArea.Cells.CountLarge = 1
            AreaType = "Cell"
        Case RangeArea.Count = RangeArea.Worksheet.Cells.Count
            AreaType = "Worksheet"
        Case RangeArea.Rows.Count = RangeArea.Worksheet.Rows.Count
            AreaType = "Column"
        Case RangeArea.Columns.Count = RangeArea.Worksheet.Columns.Count
            AreaType = "Row"
        Case Else
            AreaType = "Block"
    End Select
